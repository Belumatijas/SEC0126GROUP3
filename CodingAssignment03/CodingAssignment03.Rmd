...
model_ <- lm(Charges ~ Age + BMI + Children + Female + Smoker + WinterSprings + WinterPark + Oviedo, data = TRAINING_SET)
traing_set<- data.frame(Age = 60,
BMI = 22,
Female = 1,
Children = 0,
Smoker = 0,
City = Oviedo)
predict(model, newdata = training_set,interval = "prediction")

traing_set<- data.frame(Age = 40,
BMI = 30,
Female = 0,
Children = 1,
Smoker = 0,
